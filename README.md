...
```
![Photo](https://github.com/GohubSilently/test_task_workmate/blob/develop/Снимок%20экрана%202026-03-26%20в%2013.30.57.png)

2. Один файл.
```
uv run app/main.py -f programming.csv -r median-coffee
```
![Photo](https://github.com/GohubSilently/test_task_workmate/blob/develop/Снимок%20экрана%202026-03-26%20в%2013.30.38.png)
...
```
![Photo](https://github.com/GohubSilently/test_task_workmate/blob/develop/Снимок%20экрана%202026-03-26%20в%2013.26.16.png)
